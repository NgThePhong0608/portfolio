                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="p-8 md:p-10 bg-gradient-to-br from-indigo-500 to-purple-600 text-white">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start">
                                        <div className="text-indigo-200 mt-1 mr-4">
                                            <svg
                            ...
                            <div className="p-8 md:p-10">
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className={`w-full px-6 py-3 bg-indigo-600 text-white font-medium rounded-md hover:bg-indigo-700 transition-all ${
                                            isSubmitting
